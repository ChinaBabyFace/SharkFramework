...
public class WheelVerticalView extends AbstractWheelView {
    ...
    public WheelVerticalView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.abstractWheelViewStyle_shark);
    }
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.SharkWheelVerticalView, defStyle, 0);
        mSelectionDividerHeight = a.getDimensionPixelSize(R.styleable.SharkWheelVerticalView_selectionDividerHeight_shark, DEF_SELECTION_DIVIDER_SIZE);
        a.recycle();
    }
