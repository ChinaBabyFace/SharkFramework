...
public abstract class AbstractWheelView extends AbstractWheel {
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.SharkWheelView, defStyle, 0);
        mItemsDimmedAlpha = a.getInt(R.styleable.SharkWheelView_itemsDimmedAlpha_shark, DEF_ITEMS_DIMMED_ALPHA);
        mSelectionDividerActiveAlpha = a.getInt(R.styleable.SharkWheelView_selectionDividerActiveAlpha_shark, DEF_SELECTION_DIVIDER_ACTIVE_ALPHA);
        mSelectionDividerDimmedAlpha = a.getInt(R.styleable.SharkWheelView_selectionDividerDimmedAlpha_shark, DEF_SELECTION_DIVIDER_DIMMED_ALPHA);
        mItemOffsetPercent = a.getInt(R.styleable.SharkWheelView_itemOffsetPercent_shark, DEF_ITEM_OFFSET_PERCENT);
        mItemsPadding = a.getDimensionPixelSize(R.styleable.SharkWheelView_itemsPadding_shark, DEF_ITEM_PADDING);
        mSelectionDivider = a.getDrawable(R.styleable.SharkWheelView_selectionDivider_shark);
        a.recycle();
    }
