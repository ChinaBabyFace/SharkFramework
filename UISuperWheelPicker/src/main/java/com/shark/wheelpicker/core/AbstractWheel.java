...
import com.shark.wheelpicker.core.adapter.WheelViewAdapter;
import com.shark.wheelpicker.core.callback.OnWheelChangedListener;
import com.shark.wheelpicker.core.callback.OnWheelClickedListener;
...
public abstract class AbstractWheel extends View {
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        mVisibleItems = a.getInt(R.styleable.SharkWheelView_visibleItems_shark, DEF_VISIBLE_ITEMS);
        mIsAllVisible = a.getBoolean(R.styleable.SharkWheelView_isAllVisible_shark, false);
        mIsCyclic = a.getBoolean(R.styleable.SharkWheelView_isCyclic_shark, DEF_IS_CYCLIC);
