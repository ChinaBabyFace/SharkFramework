/**
 * PullToZoomGridViewEx.java 2015-4-13
 * 龙德恒方科技发展有限公司(c) 2015 - 2015 。
 */
package com.soaring.widget.pulltozoom;
...
import com.soaring.widget.abslistview.HeaderAndFooterGridView;

/**
 * <b>PullToZoomGridViewEx。</b>
 * <p><b>详细说明：</b></p>
 * <!-- 在此添加详细说明 -->
 * 无。
 * <p><b>修改列表：</b></p>
 ...
 * <!-- 在此添加修改列表，参考第一行内容 -->
 * <tr><td>1</td><td>Renyuxiang</td><td>2015-4-13 下午3:41:05</td><td>建立类型</td></tr>
 * 
 * </table>
 * @version 1.0
 * @author Renyuxiang
 * @since 1.0
 */
public class PullToZoomGridViewEx
		extends PullToZoomBase<HeaderAndFooterGridView>
	 ...
	 */
	@Override
	protected HeaderAndFooterGridView createRootView(Context context, AttributeSet attrs) {
		HeaderAndFooterGridView lv = new HeaderAndFooterGridView(context, attrs);
