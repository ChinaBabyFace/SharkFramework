...
//	iOS参数
	private static double METRIC_WALKING_FACTOR = 33.6;
...
//		} else {
//			mCalories += (mBodyWeight * (mIsRunning ? IMPERIAL_RUNNING_FACTOR : IMPERIAL_WALKING_FACTOR))
//			// Distance:
//					* mStepLength // inches
//					/ 63360.0; // inches/mile
//		}
        mCalories+= METRIC_WALKING_FACTOR*mStepLength/10000.0f;
