...
//			Log.e(TAG, "StepDisplayer stepsChanged:" + value);
			mSteps = value;
			passValue();
		}

		public void passValue() {
//			Log.e(TAG, "StepDisplayer passValue:");
			if (mCallback != null) {
	...
	private CaloriesNotifier.Listener mCaloriesListener = new CaloriesNotifier.Listener() {
		...
		public void valueChanged(float value) {
//			Log.e(TAG, "CaloriesNotifier valueChanged:" + value);
			mCalories = value;
			passValue();
		}

		public void passValue() {
//			Log.e(TAG, "CaloriesNotifier passValue");
			if (mCallback != null) {
