...
//	private String separatorText;
	 ...
	 * @param pickerTitle
	 */
	private WheelDataPicker(Context context, int pickerType, String pickerTitle) {
	 ...
	 * @param maxValue
	 */
	public WheelDataPicker(Context context, int pickerType, String pickerTitle, int minValue, int maxValue, int defaultValue) {
	 ...
	 * @param maxValue
	 */
	public WheelDataPicker(Context context, int pickerType, String pickerTitle, boolean canEquals, boolean canGreaterThan, int minValue, int maxValue, int defaultValue) {
		this(context, pickerType, pickerTitle);
		this.minValue = minValue;
		this.maxValue = maxValue;
		this.defaultValue = defaultValue;
	 ...
	 * @param pickerData
	 */
	public WheelDataPicker(Context context, String pickerTitle, LinkedHashMap<Integer, String> pickerData) {
	 ...
	 */
	public WheelDataPicker(Context context, String pickerTitle, LinkedHashMap<Integer, String> pickerData, Integer defaultDataKey) {
		this(context, SINGLE_PICKER, pickerTitle);
		this.firstPickerData = pickerData;
	 ...
	 */
	public WheelDataPicker(Context context, String pickerTitle, LinkedHashMap<Integer, String> firstPickerData, LinkedHashMap<Integer, String> secondPickerData) {
	 ...
	 */
	public WheelDataPicker(Context context, String pickerTitle, LinkedHashMap<Integer, String> firstPickerData, Integer firstDefaultDataKey, LinkedHashMap<Integer, String> secondPickerData, Integer secondDefaultDataKey) {
		this(context, DOUBLE_PICKER, pickerTitle);
		this.firstPickerData = firstPickerData;
		this.secondPickerData = secondPickerData;
		this.canEquals = true;
	 ...
	 * @param secondPickerData
	 */
	public WheelDataPicker(Context context, String pickerTitle, boolean canEquals, boolean canGreaterThan, LinkedHashMap<Integer, String> firstPickerData, LinkedHashMap<Integer, String> secondPickerData) {
		this(context, DOUBLE_PICKER, pickerTitle);
		this.firstPickerData = firstPickerData;
		this.secondPickerData = secondPickerData;
		this.canEquals = canEquals;
	 ...
	 * @param secondDefaultDataKey
	 */
	public WheelDataPicker(Context context, String pickerTitle, boolean canEquals, boolean canGreaterThan, LinkedHashMap<Integer, String> firstPickerData, Integer firstDefaultDataKey, LinkedHashMap<Integer, String> secondPickerData, Integer secondDefaultDataKey) {
		this(context, DOUBLE_PICKER, pickerTitle);
		this.firstPickerData = firstPickerData;
		this.secondPickerData = secondPickerData;
		this.canEquals = canEquals;
	...
	private void findViews() {
		rootLayout = View.inflate(context, R.layout.widget_wheel_data_picker, null);
...
//		if (null != separator) separator.setVisibility(View.VISIBLE);
//	}
//
//	/**
//	 * 
...
//		if (null != separator) separator.setVisibility(View.INVISIBLE);
//	}
//
//	/**
//	 * 
//	 * <b>changeSeparatorText。</b>  
//	 * <p><b>详细说明：</b></p>
//	 * <!-- 在此添加详细说明 -->
//	 * 更改分隔符显示文本
//	 * @param separator
//	 */
//	public void changeSeparatorText(String separator) {
//		this.separatorText = separator;
//		if (null != this.separator) this.separator.setText(separatorText);
//	}
